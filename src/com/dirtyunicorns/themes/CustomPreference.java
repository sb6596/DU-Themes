...
public class CustomPreference extends Preference {
    ...
    private void setResources() {
        ...
        } else if (AEXUtils.isOverlayEnabled("com.android.theme.icon_pack.kai.android")) {
            setLayoutResource(R.layout.themes_main_kai);
        } else if (AEXUtils.isOverlayEnabled("com.android.theme.icon_pack.sam.android")) {
            setLayoutResource(R.layout.themes_main_sam);
        } else if (AEXUtils.isOverlayEnabled("com.android.theme.icon_pack.victor.android")) {
